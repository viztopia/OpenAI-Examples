...
const extractPrompt = async (openaiClient, promptText = undefined) => {
  ...
  const response = await openaiClient.createCompletion("text-babbage-001", {
    "prompt": "Q: Dear bot, send my love to Steve. He loves chips and cheese A: Steve, chips, cheese Q: " + promptText + " A:",
    "temperature": 0,
    "max_tokens": 20,
    "top_p": 1,
    "frequency_penalty": 0,
...
const completePrompt = async (openaiClient, model, promptText = undefined) => {
  ...
  if (!promptText) {
    promptText = "An apple a day makes"
  }
...
export {authOpenai, filterPrompt, extractPrompt, completePrompt}